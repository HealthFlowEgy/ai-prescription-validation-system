...
class StressTestUser(HttpUser):
    ...
    def create_prescription(self):
        ...
        self.client.post("/api/prescriptions", json={
...
class TestStressScenarios:
    ...
    def test_gradual_ramp_up(self):
        ...
        for user_count in user_counts:
            ...
            # Assertions
            assert result['error_rate'] < 0.05, f"Error rate too high at {user_count} users"
    ...
    def test_spike_recovery(self):
        ...
        assert recovery_ratio < 1.2, f"System did not recover properly: {recovery_ratio:.2f}x baseline"
    ...
    def _analyze_degradation_curve(self, results):
        ...
        for i, result in enumerate(results):
            ...
            if i > 0:
                ...
                latency_change = (result['p95_latency'] - prev['p95_latency']) / prev['p95_latency']
