...
class APITestCase(unittest.TestCase):
    ...
    def test_health_endpoint(self):
        ...
        self.assertEqual(data['service'], 'AI-Based Digital Prescription Validation System')
    ...
    def test_prescription_upload(self):
        ...
        response = self.client.post('/api/prescriptions/upload', data={
    ...
    def test_prescription_upload_invalid_format(self):
        ...
        data = json.loads(response.data)
        self.assertEqual(data['error'], 'Invalid file format. Allowed formats: pdf, png, jpg, jpeg, tiff, bmp')
...
class ValidationServiceTestCase(unittest.TestCase):
    ...
    def test_dosage_validator(self):
        ...
        # Test normal dosage
        med_normal = Medication(drug_name='lisinopril', dosage='10mg', frequency='daily')
...
class NLPServiceTestCase(unittest.TestCase):
    ...
    def test_medication_extraction(self):
        ...
        lisinopril_found = any('lisinopril' in med['drug_name'].lower() for med in medications)
