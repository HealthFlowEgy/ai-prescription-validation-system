...
class BaseConfig(BaseSettings):
    ...
    DATABASE_REPLICA_URL: Optional[str] = Field(default=None, description="Read replica database URL")
    ...
    FHIR_SERVER_URL: str = Field(
        ...
        description="FHIR R4 server URL"
    )
    ...
    XROAD_SECURITY_SERVER: str = Field(default="", description="X-Road security server URL")
    ...
    NHS_CIS2_ENDPOINT: str = Field(default="", description="NHS CIS2 authentication endpoint")
    NHS_CIS2_CLIENT_ID: str = Field(default="", description="NHS CIS2 client ID")
    NHS_CIS2_CLIENT_SECRET: str = Field(default="", description="NHS CIS2 client secret")
    ...
    UHIS_ENDPOINT: str = Field(default="", description="Universal Health Insurance System endpoint")
    UHIS_API_KEY: str = Field(default="", description="UHIS API key")
    MEDICAL_SYNDICATE_API: str = Field(default="", description="Egyptian Medical Syndicate API")
    ...
    MAIL_DEFAULT_SENDER: str = Field(
        default="noreply@healthflow.egypt.gov",
    ...
    MAX_CONTENT_LENGTH: int = Field(default=16 * 1024 * 1024, description="Max file size (16MB)")
    ...
    AUTH_RATE_LIMIT: str = Field(default="5 per minute", description="Authentication rate limit")
    UPLOAD_RATE_LIMIT: str = Field(default="10 per minute", description="File upload rate limit")
    ...
    BABEL_DEFAULT_TIMEZONE: str = Field(default="Africa/Cairo", description="Default timezone")
    ...
    BACKUP_RETENTION_DAYS: int = Field(default=90, description="Backup retention period")
...
class DevelopmentConfig(BaseConfig):
    ...
    DATABASE_URL: str = "postgresql://healthflow:healthflow@localhost:5432/healthflow_dev"
...
class StagingConfig(BaseConfig):
    ...
    # Staging database
    DATABASE_URL: str = Field(default="postgresql://healthflow:healthflow@localhost:5432/healthflow_staging")
