...
class ProductionConfig:
    ...
    MAIL_DEFAULT_SENDER = os.environ.get(
        "MAIL_DEFAULT_SENDER", "noreply@prescriptionvalidator.com"
    )
    ...
    MAX_MEDICATIONS_PER_PRESCRIPTION = int(
        os.environ.get("MAX_MEDICATIONS_PER_PRESCRIPTION", 20)
    )

    # Feature Flags
    FEATURE_VOICE_INPUT = (
        os.environ.get("FEATURE_VOICE_INPUT", "true").lower() == "true"
    )
    FEATURE_FHIR_INTEGRATION = (
        os.environ.get("FEATURE_FHIR_INTEGRATION", "true").lower() == "true"
    )
    FEATURE_SNOMED_LOOKUP = (
        os.environ.get("FEATURE_SNOMED_LOOKUP", "true").lower() == "true"
    )
