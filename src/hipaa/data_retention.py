...
class DataRetentionService:
    ...
    def calculate_retention_date(
        category: DataCategory, created_at: datetime
    ) -> datetime:
        """
    ...
    def is_expired(category: DataCategory, created_at: datetime) -> bool:
        ...
        """
        expiry_date = DataRetentionService.calculate_retention_date(
            category, created_at
        )
    ...
    def archive_expired_data(category: DataCategory, dry_run: bool = True) -> Dict:
        ...
        expired_records = model.query.filter(model.created_at < cutoff_date).all()
        ...
        for record in expired_records:
            try:
                ...
                archive_record = DataRetentionService._create_archive_record(
                    category, record
                )
    ...
    def delete_expired_data(category: DataCategory, dry_run: bool = True) -> Dict:
        ...
        AuditLog.log_event(
            ...
            details={"count": count, "cutoff_date": cutoff_date.isoformat()},
        )
