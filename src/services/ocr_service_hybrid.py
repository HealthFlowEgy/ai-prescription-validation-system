...
class HybridOCRService:
    ...
    def __init__(self, default_engine: str = None):
        ...
        logger.info(
            f"Hybrid OCR Service initialized (default engine: {self.default_engine})"
        )
        ...
        if self._tesseract_ocr is None:
            try:
                ...
                spec = importlib.util.spec_from_file_location(
                    "ocr_service_original", Path(__file__).parent / "ocr_service.py"
                )
    ...
    def extract_text(
        self, image_path: str, engine: Optional[str] = None, fallback: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    def _extract_with_donut(self, image_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = medical_ocr.process_prescription(
                image_path=image_path, validate_type=True
            )
    ...
    def compare_engines(self, image_path: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "comparison": {
                ...
                "recommended": (
                    "donut"
                    if donut_result.get("confidence", 0)
