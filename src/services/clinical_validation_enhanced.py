...
class DrugInteractionService:
    ...
    def _check_pair(self, drug1: str, drug2: str) -> Optional[Dict[str, Any]]:
        ...
        for (d1, d2), interaction_info in critical_pairs.items():
            if (d1 in drug1.lower() and d2 in drug2.lower()) or (
                ...
                result = {"drug1": drug1, "drug2": drug2, **interaction_info}
    ...
    def _severity_score(self, severity: str) -> int:
        ...
        scores = {"SEVERE": 4, "MODERATE": 3, "MINOR": 2, "UNKNOWN": 1}
...
class ClinicalValidationService:
            ...
            flags.append(
                ValidationFlag(
                    ...
                    details={
                        ...
                        "threshold": ValidationConfig.OCR_CONFIDENCE_THRESHOLD,
                    },
                )
            )
    ...
    def _check_critical_medications(
        ...
        for med in medications:
            ...
            if any(
                critical in med_name
                for critical in ValidationConfig.CRITICAL_MEDICATIONS
            ):
                flags.append(
                    ValidationFlag(
    ...
    def _check_patient_risk(
        self, prescription: Prescription, nlp_result: Dict[str, Any]
    ) -> List[ValidationFlag]:
    ...
    def _notify_pharmacist(
        self, prescription: Prescription, flags: List[ValidationFlag]
    ):
