...
from src.encryption.encrypted_types import (
    EncryptedString,
    EncryptedText,
    EncryptedDate
)
...
def key_manager(redis_client, encryption_key, monkeypatch):
    ...
    import base64
    monkeypatch.setenv('ENCRYPTION_KEY_CURRENT', base64.b64encode(encryption_key).decode())
...
class TestEncryptionKeyManager:
    ...
    def test_get_current_key_from_cache(self, redis_client, key_manager, encryption_key):
    ...
    def test_get_previous_keys(self, key_manager, monkeypatch):
        ...
        monkeypatch.setenv('ENCRYPTION_KEY_PREVIOUS_1', base64.b64encode(prev_key_1).decode())
        monkeypatch.setenv('ENCRYPTION_KEY_PREVIOUS_2', base64.b64encode(prev_key_2).decode())
...
class TestPrescriptionModel:
    ...
    def test_create_prescription_with_encrypted_fields(self, test_database, encryption_service, monkeypatch):
    ...
    def test_query_prescription_decrypts_automatically(self, test_database, encryption_service, monkeypatch):
    ...
    def test_to_dict_excludes_phi_by_default(self, test_database, encryption_service, monkeypatch):
...
class TestEndToEndEncryption:
    ...
    def test_complete_prescription_workflow(self, test_database, encryption_service, monkeypatch):
